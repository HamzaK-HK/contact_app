...
class ContactController extends Controller
{
    ...
    public function picture(Request $request, Contact $contact)
    {
        ...
        if ($contact->update($data)) {
            return back()->with(['success' => 'Successfully updated picture!']);
        } else {
            return back()->with(['failure' => 'Failed to update picture!']);
        }
    }
    ...
    {
        if ($contact->delete()) {
            return redirect()->route('contacts')->with(['success' => 'Successfully deleted!']);
        } else {
            return redirect()->route('contacts')->with(['failure' => 'Failed to delete!']);
        }
    }
}
